...
- **Уведомление о чужой сборке (#160)** остаётся скриптом в веб-виде доски (`w.Init`): нижняя плашка на всю ширину доски, над ней панели. Правило для шапки `#header .build-rev::before` меняется на новое место версии сборки (раздел 9, задача плана).
