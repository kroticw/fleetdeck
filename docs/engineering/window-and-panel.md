...
- **Measured (spike, 26.6.2): glass over a `WKWebView` samples the web content under it.** Glass placed under a transparent web view samples only the desktop. So the board's web view stays the bottom layer and the panels sit above it; the side surfaces are transparent web views inside the glass.
